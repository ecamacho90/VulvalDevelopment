function ABC_SMC_Algorithm_OLCM_Template_Modelv10_v1_Fates_AbsDistance(mutantstofit,parfitnumbers,EpT,T,Tmax,Nmax,Numberofparticleseachjob,PreviousData,namenewdata,CovarianceMatricesParticles,weightsdistances,streamnum,jobnum)
...
save(['/scratch/ec47/',namenewdata,'_',num2str(jobnum)],'newEpT','NewData','NewFates','streamnum','substreamnum','eltime','i','icomp')

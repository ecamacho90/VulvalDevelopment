...
%Vectorial:
            ...
            if distance<=newEpT
                ...
                NewFates(:,:,:,N) = fatesmut;
                if rem(N,100)==0
                   save([namenewdata,'_',num2str(jobnum),'_',num2str(N/100)],'newEpT','NewData','NewFates','streamnum','substreamnum','i','icomp')
...
save(['localpath/',namenewdata,'_',num2str(jobnum)],'newEpT','NewData','NewFates','streamnum','substreamnum','eltime','i','icomp')
